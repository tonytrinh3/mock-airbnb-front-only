...
class TripsPage extends React.Component {
    ...
    renderReservation() {
        ...
        return tripsTEMP?.map((trip, i) => {
            ...
            const { bookingId, imgs, endDate, location, startDate, title } = trip.reservation;
                ...
                return (
                    <div className="trip-card" key={i}>
                        <img
                            ...
                            src={require(`../../img/booking-page/listing-${bookingId}/${imgs.img_1}.jpg`)}
                            alt={`img_${i}`}
                            key={`img_${i}`}
                        />
                        <div className="trip-card__description ">
                            <p className="trip-card__description__date ">{`${
                                startDate.split(" ")[0]
                            } ${startDate.split(" ")[1]} - ${endDate.split(" ")[0]} ${
                                endDate.split(" ")[1]
                            }`}</p>
                            {/* <h2 className="header-medium">{trip.reservation.description}</h2> */}
                            <h3 className="trip-card__description__location ">
                                {location.split(",")[0]}
                            </h3>
                            <p className="trip-card__description__title ">{title}</p>
                            <p href="" className="trip-card__description__more-info">
    ...
    render() {
        ...
        return (
            <div className="trips-page">
                ...
                <div className="trips-page__cards">{this.renderReservation()}</div>
